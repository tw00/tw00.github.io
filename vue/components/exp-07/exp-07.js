...
module.exports.__inject__ = function (shadowRoot) {
  add("082b5b4c", content, shadowRoot)
};
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_RadioButton_vue_vue_type_style_index_0_id_975b013a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("e1e4");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_RadioButton_vue_vue_type_style_index_0_id_975b013a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_RadioButton_vue_vue_type_style_index_0_id_975b013a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
...
var ___CSS_LOADER_AT_RULE_IMPORT_0___ = __webpack_require__("b5af");
var ___CSS_LOADER_AT_RULE_IMPORT_1___ = __webpack_require__("c7ab");
exports = ___CSS_LOADER_API_IMPORT___(false);
exports.i(___CSS_LOADER_AT_RULE_IMPORT_0___);
exports.i(___CSS_LOADER_AT_RULE_IMPORT_1___);
// Module
exports.push([module.i, ".colorbox{height:60px;font-weight:700;font-size:18pt;-ms-flex-pack:distribute;justify-content:space-around;color:#fff}.colorbox,.colorbox>div{width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.colorbox>div{height:100%;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}.shadebox{height:60px;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;color:#000}.shade,.shadebox{width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.shade{height:100%;font-weight:700;font-size:10pt;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}.is-shades{color:#fff}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"687a3548-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/experiments/Experiment07.vue?vue&type=template&id=7efd0dfc&shadow
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticStyle:{"margin":"0 auto","max-width":"1024px","padding":"0 2em"}},[_c('h1',{staticStyle:{"margin-top":"2em"}},[_vm._v("BASE COLORS")]),_vm._l((_vm.base_colors),function(c){return _c('div',{key:'base-' + c.hex(),staticClass:"colorbox",style:({ backgroundColor: c })},[_c('div',{staticStyle:{"width":"30%"}},[_vm._v(_vm._s(c.hsl().string()))]),_c('div',{staticStyle:{"width":"30%"}},[_vm._v(_vm._s(c.hex()))]),_c('div',{staticStyle:{"width":"30%"}},[_vm._v(_vm._s(c.rgb()))])])}),_c('h1',{staticStyle:{"margin-top":"4em"}},[_vm._v("TINTS & SHADES")]),_vm._l((_vm.base_colors_with_tints_and_shades),function(info,index){return _c('div',{key:'shade-' + index,staticStyle:{"text-align":"left"}},[_c('h1',{style:({ color: info.base })},[_vm._v(_vm._s(info.title)+" for "+_vm._s(info.base.hex()))]),_c('div',{staticClass:"shadebox"},_vm._l((info.colors),function(c){return _c('div',{key:index + '-' + c.hex(),class:['shade', 'is-' + info.title.toLowerCase() ],style:({ backgroundColor: c })},[_vm._v(" "+_vm._s(c.hex())+"   ")])}),0)])}),_c('h1',{staticStyle:{"margin-top":"4em"}},[_vm._v("COLOR WHEEL")]),_c('div',{staticStyle:{"width":"54em","margin":"0 auto","text-align":"left"}},[_vm._v(" saturation_decrease: "),_c('vue-slider',{attrs:{"min":0,"max":50,"interval":1},model:{value:(_vm.saturation_decrease),callback:function ($$v) {_vm.saturation_decrease=$$v},expression:"saturation_decrease"}}),_vm._v(" lightness_increase: "),_c('vue-slider',{attrs:{"min":0,"max":50,"interval":1},model:{value:(_vm.lightness_increase),callback:function ($$v) {_vm.lightness_increase=$$v},expression:"lightness_increase"}}),_c('div',{staticStyle:{"margin-top":"2em"}}),_vm._v(" lumi_fix_ratio: "),_c('vue-slider',{attrs:{"min":0,"max":1,"interval":0.01},model:{value:(_vm.lumi_fix_ratio),callback:function ($$v) {_vm.lumi_fix_ratio=$$v},expression:"lumi_fix_ratio"}}),_vm._v(" lumi_target: (Avg. "+_vm._s(Math.round( _vm.colorwheel.reduce(function (acc, obj) { return acc + obj.luminance; }, 0) / _vm.num_of_colors ))+") "),_c('vue-slider',{attrs:{"min":0,"max":255,"interval":1},model:{value:(_vm.lumi_target),callback:function ($$v) {_vm.lumi_target=$$v},expression:"lumi_target"}}),_c('div',{staticStyle:{"margin":"0.5em 0 1em 0"}},[_vm._v(" lumi_mix_method: "),_c('radio-button',{attrs:{"name":"lumi_mix_method","label":"LIGTHEN_DARKEN","value":_vm.lumi_mix_method},on:{"change":function($event){_vm.lumi_mix_method = $event}}}),_c('radio-button',{attrs:{"name":"lumi_mix_method","label":"SHADE_TINT","value":_vm.lumi_mix_method},on:{"change":function($event){_vm.lumi_mix_method = $event}}}),_c('radio-button',{attrs:{"name":"lumi_mix_method","label":"WHITEN_BLACKEN","value":_vm.lumi_mix_method},on:{"change":function($event){_vm.lumi_mix_method = $event}}}),_c('radio-button',{attrs:{"name":"lumi_mix_method","label":"LIGHTNESS","value":_vm.lumi_mix_method},on:{"change":function($event){_vm.lumi_mix_method = $event}}})],1),_c('div',{staticStyle:{"margin":"0.5em 0 1em 0"}},[_vm._v(" lumi_calc_method: "),_c('radio-button',{attrs:{"name":"lumi_calc_method","label":"STANDARD","value":_vm.lumi_calc_method},on:{"change":function($event){_vm.lumi_calc_method = $event}}}),_c('radio-button',{attrs:{"name":"lumi_calc_method","label":"PERCEIVED1","value":_vm.lumi_calc_method},on:{"change":function($event){_vm.lumi_calc_method = $event}}}),_c('radio-button',{attrs:{"name":"lumi_calc_method","label":"PERCEIVED2","value":_vm.lumi_calc_method},on:{"change":function($event){_vm.lumi_calc_method = $event}}}),_c('radio-button',{attrs:{"name":"lumi_calc_method","label":"PERCEIVED3","value":_vm.lumi_calc_method},on:{"change":function($event){_vm.lumi_calc_method = $event}}}),_c('radio-button',{attrs:{"name":"lumi_calc_method","label":"PERCEIVED4","value":_vm.lumi_calc_method},on:{"change":function($event){_vm.lumi_calc_method = $event}}})],1),_vm._m(0),_vm._l((_vm.colorwheel),function(obj){return _c('div',{key:'wheel-' + obj.color.hex(),staticClass:"colorbox"},[_c('div',{style:({ backgroundColor: obj.color })},[_vm._v(" "+_vm._s(obj.color.hsl().string())+" | "+_vm._s(obj.luminance)+" ")]),_c('div',{staticStyle:{"width":"20px"}}),_c('div',{style:({ backgroundColor: obj.color_fixed })},[_vm._v(" "+_vm._s(obj.color_fixed.hsl().string())+" | "+_vm._s(obj.luminance_fixed)+" ")])])})],2)],2)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"colorbox",staticStyle:{"margin-top":"2em","color":"black","font-size":"15pt"}},[_c('div',[_vm._v("Original")]),_c('div',[_vm._v("Corrected luminance")])])}]


// CONCATENATED MODULE: ./src/experiments/Experiment07.vue?vue&type=template&id=7efd0dfc&shadow
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"687a3548-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/RadioButton.vue?vue&type=template&id=975b013a&scoped=true&
var RadioButtonvue_type_template_id_975b013a_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('label',{staticClass:"radio"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.radioButtonValue),expression:"radioButtonValue"}],attrs:{"type":"radio","name":_vm.name},domProps:{"value":_vm.label,"checked":_vm._q(_vm.radioButtonValue,_vm.label)},on:{"change":function($event){_vm.radioButtonValue=_vm.label}}}),_c('span',[_vm._v(_vm._s(_vm.label))])])}
var RadioButtonvue_type_template_id_975b013a_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/RadioButton.vue?vue&type=template&id=975b013a&scoped=true&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/@vue/cli-plugin-babel/node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/RadioButton.vue?vue&type=script&lang=js&
//
//
//
//
...
// EXTERNAL MODULE: ./src/components/RadioButton.vue?vue&type=style&index=0&id=975b013a&scoped=true&lang=css&
var RadioButtonvue_type_style_index_0_id_975b013a_scoped_true_lang_css_ = __webpack_require__("1748");
...
var component = normalizeComponent(
  ...
  RadioButtonvue_type_template_id_975b013a_scoped_true_render,
  RadioButtonvue_type_template_id_975b013a_scoped_true_staticRenderFns,
  false,
  null,
  "975b013a",
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/@vue/cli-plugin-babel/node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/experiments/Experiment07.vue?vue&type=script&lang=js&shadow
//
//
//
//
...
/* const base_colors = [
  (new Color('#F9AE00')), // HSL: 42° 100% 49%
  (new Color('#7FB800')), // HSL: 79° 100% 36% (+37)
  (new Color('#084C61')), // HSL: 194° 85% 21% (+115)
  (new Color('#6B0252')), // HSL: 314° 96% 21% (+120)
]; */

const base_colors = [new color_default.a('#6B0252').hue(310).saturationl(95).lightness(20), // HSL: 315° 96% 21% (+120)
new color_default.a('#F9AE00').hue(40).saturationl(95).lightness(50), // HSL: 40° 100% 49%
new color_default.a('#7FB800').hue(70).saturationl(95).lightness(35), // HSL: 75° 100% 36% (+37)
new color_default.a('#084C61').hue(190).saturationl(95).lightness(20) // HSL: 190° 85% 21% (+115)
]; // https://stackoverflow.com/questions/6615002/given-an-rgb-value-how-do-i-create-a-tint-or-shade

function calc_tint(color, tint_factor) {
  // Tints: New value = current value + ((255 - current value) x tint factor)
  let rgb = color.rgb().array().map(value => {
    return value + (255 - value) * tint_factor;
  });
  return new color_default.a(rgb);
}

function calc_shade(color, shade_factor) {
  // Shades: New value = current value x shade factor
  let rgb = color.rgb().array().map(value => {
    return value * (1 - shade_factor);
  });
  return new color_default.a(rgb);
}

function lumi_standard(color) {
  const [R, G, B] = color.rgb().array();
  return 0.2126 * R + 0.7152 * G + 0.0722 * B;
}

function lumi_perceived1(color) {
  const [R, G, B] = color.rgb().array();
  return 0.299 * R + 0.587 * G + 0.114 * B;
}

function lumi_perceived2(color) {
  const [R, G, B] = color.rgb().array();
  return Math.sqrt(0.299 * Math.pow(R, 2) + 0.587 * Math.pow(G, 2) + 0.114 * Math.pow(B, 2));
}

function _sRGB_to_linear(colorChannel) {
...
function lumi_perceived3(color) {
  const [R, G, B] = color.rgb().array();

  let linR = _sRGB_to_linear(R / 255);

  let linG = _sRGB_to_linear(G / 255);

  let linB = _sRGB_to_linear(B / 255);

  let y = 0.2126 * linR + 0.7152 * linG + 0.0722 * linB;
  return _Y_to_Lstar(y) * (255 / 100);
}

function lumi_perceived4(color) {
  const [R, G, B] = color.rgb().array();
  ...
  let y = Math.sqrt(0.299 * Math.pow(linR, 2) + 0.587 * Math.pow(linG, 2) + 0.114 * Math.pow(linB, 2));
  return _Y_to_Lstar(y) * (255 / 100);
}

/* harmony default export */ var Experiment07vue_type_script_lang_js_shadow = ({
  data() {
    return {
      base_colors,
      num_of_colors: 12,
      saturation_decrease: 5,
      lightness_increase: 15,
      lumi_fix_ratio: 1.0,
      lumi_target: 180,
      lumi_mix_method: 'LIGHTNESS',
      lumi_calc_method: 'PERCEIVED2'
    };
  },

  computed: {
    base_colors_with_tints_and_shades() {
      let n = 8;
      let result = [];
      this.base_colors.forEach(rgb => {
        let color = new color_default.a(rgb);
        let tints = [];

        for (let i = 1; i <= n; i++) {
          // tints[i] = color.lighten( i / n );
          tints[i - 1] = calc_tint(color, i / n);
        }
        ...
        for (let i = 1; i <= n; i++) {
          // shades[n + i] = color.darken( i / n );
          shades[i - 1] = calc_shade(color, i / n);
        }
        ...
        //   shades[i] = color.lightness( ( i / ( 2 * n ) ) * 100 );
        // }
      });
      return result;
    },
    ...
    colorwheel() {
      const n = this.num_of_colors; // const target_lumi = 179;
      // const lumi_fix_factor = 0.8;

      const target_lumi = this.lumi_target;
      const lumi_fix_factor = this.lumi_fix_ratio;
      const method = this.lumi_mix_method;
      let lumi_func = null;

      switch (this.lumi_calc_method) {
        case 'PERCEIVED1':
          lumi_func = lumi_perceived1;
          break;

        case 'PERCEIVED2':
          lumi_func = lumi_perceived2;
          break;

        case 'PERCEIVED3':
          lumi_func = lumi_perceived3;
          break;

        case 'PERCEIVED4':
          lumi_func = lumi_perceived4;
          break;

        case 'STANDARD':
          lumi_func = lumi_standard;
          break;
      }

      const init_color = new color_default.a(base_colors[0]);
      let color = new color_default.a(init_color);
      color = color.hsl().hue(40).saturationl(100 - this.saturation_decrease).lightness(50 + this.lightness_increase);
      let res = [];

      for (let i = 0; i < n; i++) {
        let color_fixed = new color_default.a(color);
        let local_target_lumi = (1 - lumi_fix_factor) * lumi_func(color) + lumi_fix_factor * target_lumi;

        for (let iter = 0; iter < 100; iter++) {
          let lumi = lumi_func(color_fixed);
          let err = Math.abs(lumi - local_target_lumi);

          if (lumi < local_target_lumi) {
            switch (method) {
              case 'LIGTHEN_DARKEN':
                color_fixed = color_fixed.lighten(err * 0.001);
                break;

              case 'SHADE_TINT':
                color_fixed = calc_tint(color_fixed, err * 0.001);
                break;

              case 'WHITEN_BLACKEN':
                color_fixed = color_fixed.whiten(0.01);
                break;

              case 'LIGHTNESS':
                color_fixed = color_fixed.lightness(color_fixed.lightness() + 0.25 * err * 0.5);
                break;
            }
          }
          ...
          if (lumi > local_target_lumi) {
            switch (method) {
              case 'LIGTHEN_DARKEN':
                color_fixed = color_fixed.darken(err * 0.001);
                break;

              case 'SHADE_TINT':
                color_fixed = calc_shade(color_fixed, err * 0.001);
                break;

              case 'WHITEN_BLACKEN':
                color_fixed = color_fixed.blacken(0.01);
                break;
        ...
        res[i] = {
          ...
          luminance: Math.round(lumi_func(color)),
          luminance_fixed: Math.round(lumi_func(color_fixed))
        };
        color = color.rotate(360 / n);
      }
    ...
    diff() {
      ...
      for ( let i = 0; i < this.list.length - 1; i++ ) {
        d[i] = this.list[i] - this.list[i + 1];
      }
      return d;
    },
    list() {
      return this.base_colors.map(rgb => {
        let color = new Color(rgb);
        // console.log(color)
        // color.hsv();
        return color.hsv().color[2];
      })
    }
    */
...
// CONCATENATED MODULE: ./src/experiments/Experiment07.vue?vue&type=script&lang=js&shadow
 /* harmony default export */ var experiments_Experiment07vue_type_script_lang_js_shadow = (Experiment07vue_type_script_lang_js_shadow); 
// CONCATENATED MODULE: ./src/experiments/Experiment07.vue?shadow



function injectStyles (context) {
  
  var style0 = __webpack_require__("eb2e")
...
var Experiment07shadow_component = normalizeComponent(
  experiments_Experiment07vue_type_script_lang_js_shadow,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var Experiment07shadow = (Experiment07shadow_component.exports);
...
window.customElements.define('exp-07', vue_wc_wrapper(external_Vue_default.a, Experiment07shadow))
...
// load the styles
var content = __webpack_require__("e436");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add CSS to Shadow Root
var add = __webpack_require__("35d6").default
module.exports.__inject__ = function (shadowRoot) {
  add("62b0e695", content, shadowRoot)
};
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "label.radio[data-v-975b013a]{margin-right:20px}", ""]);
// Exports
module.exports = exports;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Experiment07_vue_vue_type_style_index_0_lang_css_shadow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("097d");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Experiment07_vue_vue_type_style_index_0_lang_css_shadow__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Experiment07_vue_vue_type_style_index_0_lang_css_shadow__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Experiment07_vue_vue_type_style_index_0_lang_css_shadow__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Experiment07_vue_vue_type_style_index_0_lang_css_shadow__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ })

/******/ });
//# sourceMappingURL=exp-07.js.map